...
#define _TC_PREFIX "/usr/local/"
#define _TC_INCLUDEDIR "/usr/local/include"
#define _TC_LIBDIR "/usr/local/lib/"
#define _TC_LIBEXECDIR "/usr/local/libexec"
#define _TC_BINDIR "/usr/local/bin/"

#define _TC_APPINC "/usr/local/include/"
#define _TC_APPLIBS "/usr/local/lib/"
